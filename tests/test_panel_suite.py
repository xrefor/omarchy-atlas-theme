...
import atlas_panel
from atlas_system import ui as system_ui
from atlas_projects import ui as projects_ui
from atlas_maintain import ui as maintain_ui


class PanelSuiteStyleTests(unittest.TestCase):
    def test_local_panels_share_the_pinned_header_contract(self):
        panels = (
            ('system', system_ui, (1, 2)),
            ('projects', projects_ui, (1, 2)),
            ('maintain', maintain_ui, (1, 2, 3)),
        )
